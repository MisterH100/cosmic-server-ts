    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                res
                    .status(500)
                    .json({ message: "failed to find schedule , internal server error", error: error_1 });
                return [3 /*break*/, 4];
...
var getSchedules = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var schedules, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, schedule_model_1.default.find({})];
            case 1:
                schedules = _a.sent();
                res.status(200).json({ schedules: schedules, message: "schedules found" });
                return [3 /*break*/, 3];
            case 2:
                error_2 = _a.sent();
                res
                    .status(500)
                    .json({ message: "failed to find schedule , internal server error", error: error_2 });
                return [3 /*break*/, 3];
