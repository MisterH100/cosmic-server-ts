...
const RegisterCosmicAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { email, password } = req.body;
    const role = "admin";
    const clearanceLevel = 0;
    try {
        const user = yield cosmic_admin_model_1.default.findOne({ email: email });
        if (user) {
            ...
            const newUser = new cosmic_admin_model_1.default({
                email: email,
...
exports.RegisterCosmicAdmin = RegisterCosmicAdmin;
const LoginCosmicAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { email, password } = req.body;
    try {
        const user = yield cosmic_admin_model_1.default.findOne({ email: email });
        if (!user) {
            ...
            if (validatePassword) {
                ...
                yield cosmic_admin_model_1.default.findByIdAndUpdate(user._id, {
                    $set: { logged_in: true },
                });
...
exports.LoginCosmicAdmin = LoginCosmicAdmin;
const LogoutCosmicAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { email } = req.body;
    try {
        yield cosmic_admin_model_1.default.findOneAndUpdate({ email: email }, { logged_in: false });
...
exports.LogoutCosmicAdmin = LogoutCosmicAdmin;
const UpdateCosmicAdminClearance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { email, level } = req.body;
    try {
        yield cosmic_admin_model_1.default.findOneAndUpdate({ email: email }, { clearance_level: level });
